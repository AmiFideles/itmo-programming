...
public class Person implements Comparable<Person>, Serializable {
    ...
    public static Person transferToPerson(PersonDTO personDTO) {
        return new Person(
                personDTO.getId(),
                personDTO.getName(),
                Coordinates.transformToCoordinates(personDTO.getCoordinates()),
                personDTO.getCreationDate(),
                personDTO.getHeight(),
                personDTO.getBirthday(),
                personDTO.getPassportID(),
                Color.transformToColor(personDTO.getHairColor()),
                Location.transformToLocation(personDTO.getLocation()));
